...
var sortedBands = bands.sort(function (a, b) { return strip(a) > strip(b) ? 1 : -1; });
document.getElementById('bands').innerHTML = sortedBands.map(function (band) { return "<li>" + band + "</li>"; }).join('');
